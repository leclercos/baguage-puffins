function create_champ(i) {
	...
	var tablenom=['Action','Annee','Lieudit','Bague','Colonie','Secteur','Terrier','PTD','PR1','PR2'],
		tablenom1=['action','annee','lieudit','bague','colonie','secteur','terrier','ptd','pr1','pr2'];
	...
	else if(document.getElementById('new_champ_'+i).value=='annee')
	{
		form+='<select name="champ'+i+'" id="annee">';
	...
	form+='<img src="images/icone_fermer.png" alt="" id="ferm'+i+'" onclick="supprimer(this.id,'+i+')" class="icone"/>';
...
function supprimer(id,i){
	...
	if(i>1) {form='<img src="images/icone_fermer.png" alt="" id="ferm'+p+'" onclick="supprimer(this.id)" />';}
